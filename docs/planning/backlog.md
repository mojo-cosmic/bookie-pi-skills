...
| BK-003 | Done | SPEC-001 | Implement common metadata and all initial type schemas. See [evidence](evidence/BK-003.md). | BK-002 | Every type has positive and required negative fixtures; schema meta-validation passes. |
| BK-004 | Ready | SPEC-001 | Define relation vocabulary, lifecycle/state enums, UID prefixes, and named cross-file policy rules. | BK-003 | Reference tables and fixtures cover inverse, supersession, immutable, and digest boundaries. |
